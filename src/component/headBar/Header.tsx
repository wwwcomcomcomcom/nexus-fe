...
export default function Header() {
  ...
  return (
    <header className="flex items-center justify-between px-10 w-full sticky top-0 z-50 h-16 bg-white ">
      <nav className="flex flex-row w-full h-full border-b border-[#E4E4E4] py-4">
