const IntroduceProject: React.FC = () => {
  return (
    <div className="w-full flex justify-start">
      <div className="md:w-2/3 w-full bg-[#F4F9FF] rounded-3xl md:rounded-l-none p-16">
        ...
        <div className="py-16">
          <p>
            ...
            유아이유엑스 처음 해보는데 정말 어렵네요. 키보드를 일단 치고 있으면
            뭔가 일 하는 것처럼 보여서 쓰고 있습니다. 계속 하면 들킬 것 같으니
            여기까지 하겠습니다. 감사합니다.예시로 쓰는 프로젝트 소개입니다.
            유아이유엑스
          </p>
        </div>
      </div>
