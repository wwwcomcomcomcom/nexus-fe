    ...
    <main className="">
      <div className="relative my-20">
        <div className="relative ">
          <section className="block bg-[#F4F9FF] rounded-l-3xl ml-[35%] align-start py-20 pl-32 max-h-[70vh] overflow-y-auto z-50">
          ...
          <GreenTopBox className="absolute top-[-50px] left-[50px] z-10 h-[300px]" />
